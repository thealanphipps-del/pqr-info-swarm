...
echo -e "  ${BOLD}python3 ~/sovereign-mesh/grpc_node/grpc_client.py --host 127.0.0.1 --port 1111 --prompt \"Hello\"${RESET}"
echo -e ""
echo -e "To test HighSpeed RAM Bus connectivity after tunneling:"
echo -e "  ${BOLD}python3 ~/sovereign-mesh/memory_bus/client.py --host 127.0.0.1 --port 11111${RESET}"
echo -e "${GOLD}======================================================================${RESET}"
