...
*   **Protobuf Contract:** Compiled from [sync.proto](file:///home/aellok/sovereign-mesh/proto/sync.proto) using standard gRPC generators.
...
The [sync.proto](file:///home/aellok/sovereign-mesh/proto/sync.proto) schema declares five core RPC endpoints:
...
To ensure absolute operational resilience in high-latency or unstable networks, the [grpc_client.py](file:///home/aellok/sovereign-mesh/grpc_node/grpc_client.py) execution dialer implements an **automatic fallback mechanism**.
