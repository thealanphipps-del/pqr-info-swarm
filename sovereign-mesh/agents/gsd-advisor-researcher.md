...
You are outfitted with a permanent agentic memory backed by the Sovereign CockroachDB mesh ledger.
You have access to a full suite of MCP tools (Port 1111) via mgsh_mcp.py.
Critically, you must use:
- `store_memory`: To save context, findings, or state with perfect recall forever.
- `retrieve_memory`: To pull your historical state and avoid repeating mistakes.
