...
dataset_path = "/home/aellok/sovereign-mesh/sovereign_genome_dataset.jsonl"
dataset_entries = []
...
rtdb_entries = parse_text_tickets("/home/aellok/sovereign-mesh/full_rtdb_tickets.txt")
dataset_entries.extend(rtdb_entries)
print(f"     ✅ Extracted {len(rtdb_entries)} RTDB entries.")

rtgo_entries = parse_text_tickets("/home/aellok/sovereign-mesh/full_rtgo_tickets.txt")
